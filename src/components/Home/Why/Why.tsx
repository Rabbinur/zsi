...
const quick=[
    {
        ...
        icon:<SiAdguard/>,
        desc:"Pick your travel date in advance, "
    },
    {
        id:2, 
        title:"24/7 Customer Support",
        icon:<TbPhoneCall/>,
        desc:"For any queries, comments and support. "
    },
    {
        id:3, 
    ...
    <Container>
      <div>
        ...
        <div className="grid grid-cols-1
         md:grid-cols-2 lg:grid-cols-3 gap-5 mt-8">
          {quick.map((item) => (
            <div key={item.id} className="group font-mul cursor-pointer ">
              <div
                className="text-center flex flex-col
                 md:flex-row gap-3 items-center p-[15px] py-5
                 transition-colors bg-[#fefefe] 
           
               text-black border  
               rounded-md shadow-md group-hover:shadow-2xl"
              >
